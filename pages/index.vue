<template>
  <div class="home">
    <h1 class="home__title">
      Welcome to <br /><a class="home__title__link" href="https://developers.line.biz/en/docs/liff/overview/"
        >LIFF Starter!</a
      >
    </h1>
...
export default {
  ...
  methods: {
    ...
    sendHelloToFriend() {
      console.log(this.$liff.isApiAvailable('shareTargetPicker'));
      if (this.$liff.isApiAvailable('shareTargetPicker')) {
        this.$liff.shareTargetPicker([
          {
            type: 'text',
            text: 'Hello, World!'
          }
